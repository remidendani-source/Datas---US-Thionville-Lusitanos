...
if mode == "⚽ Collectif":
    ...
    if joueur_A == "— Sélectionner —" or joueur_B == "— Sélectionner —":
        ...
        df_cmp_A_all = df_cmp_A_all[df_cmp_A_all["Minutes played"]>20].sort_values("Journée").reset_index(drop=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    if _joueur_A == "— Sélectionner —" or _joueur_B == "— Sélectionner —":
        ...
        def _get_df_cmp(joueur, selected):
            ...
            df = df[df["Minutes played"]>20].sort_values("Journée").reset_index(drop=True)
            if selected:
