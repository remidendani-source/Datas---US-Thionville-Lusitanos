...
ALL_PLAYERS = [
    ...
    # Nouveaux L3 2026-27
    "Bourama Diarra","Jérémy Atangana","Emmanuel Montet","Kyllian Tubio","Gauthier Laurens","Fadel Gobitaka"
]
...
ALL_PLAYERS = [
    ...
    "Bryan Labissière","Alexis Gouletquer","Karim Bouhmidi","Chafik Gourichy",
    # Nouveaux L3 2026-27
    "Bourama Diarra","Jérémy Atangana","Emmanuel Montet","Kyllian Tubio","Gauthier Laurens"
]
COMP_LABELS = {
    "France. National 2": "National 2 · 2025-26",
    "France. Ligue 3":    "Ligue 3 · 2026-27",
...
if mode == "📊 KPI'S LIGUE 3":
    ...
    sc_bg_l3, sc_fg_l3 = score_style(l3_score)
    ...
    <table class="kpi-tbl" style="margin-top:8px;">
      <tbody>
        <tr>
          ...
          <td style="padding-left:12px;font-weight:700;color:#C9A84C;">
            US Thionville Lusitanos <span style="font-size:10px;color:#8b949e;font-weight:400;">L3 26/27 — J1</span>
          </td>
          {td_n2(thl_l3["K1"],"k1")}
          {td_n2(thl_l3["K2"],"k2")}
          {td_n2(thl_l3["K3"],"k3")}
          {td_n2(thl_l3["K4"],"k4")}
          {td_n2(thl_l3["K5"],"k5",pct=True)}
          {td_n2(thl_l3["K6"],"k6")}
          {td_n2(thl_l3["K7"],"k7")}
          <td style="text-align:center;">
            <span class="score-pill" style="background:{sc_bg_l3};color:{sc_fg_l3};">{l3_score}/7</span>
          </td>
        </tr>
      </tbody>
    </table>
    <div style="font-size:10px;color:#555;margin-top:4px;padding-left:4px;">⚠️ K3 et K4 calculés sur 1 seul match — à affiner au fil de la saison</div>
    """
    st.markdown("<br>", unsafe_allow_html=True)
